...
PAPER = ROOT / "paper"
DOWNLOADS_PDF = Path("C:/Users/wangz/Downloads/118.pdf")
DESKTOP_PDF = Path("C:/Users/wangz/Desktop/118.pdf")
ROOT_PDF = ROOT.parent / "118.pdf"
CHILD_PDF = ROOT / "118.pdf"
...
def main():
    ...
    expected_files = {
        ...
        "fixed_budget_cell": RESULTS / "fixed_budget_cell_metrics.csv",
        "fixed_budget_seed": RESULTS / "fixed_budget_seed_metrics.csv",
        "fixed_budget_metric": RESULTS / "fixed_budget_metrics.csv",
        "fixed_budget_pairwise": RESULTS / "fixed_budget_pairwise_stats.csv",
    ...
    print(f"Paper 118 validation passed. SHA256={digest} pages={pages}")
