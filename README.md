...
This repository contains a hardened, honest workshop-only robotics paper draft for `world_model_audits_from_failed_rollouts`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/118.pdf`
