...
Honest strongest claim: `Use failed rollouts to localize which physical assumptions the world model lacks.` is a plausible branch-structured mechanism for robot world-model evaluation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
